...
const VerifyModules_1 = require("./VerifyModules");
...
void (function () {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let checked_files = yield (0, VerifyModules_1.VerifyModules)({
        ...
        let extracted = yield (0, ExtractModules_1.ExtractModules)({
            verificationBinaries: { fstar_binary: "fstar.exe", z3_binary: "z3.exe" },
        ...
        let ocaml_package = yield (0, OCamlCmxsBuilder_1.OCamlCmxsBuilder)({
            ocamlBinaries: {
